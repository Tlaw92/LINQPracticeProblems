...
namespace PracticeProblemsLINQ
{
    public static class LinqProblems
    {
        ...
        #region Problem 3
        //(5 points) Problem 3
        //Using LINQ, write a method that takes in a list of customers and 
        //returns the lone customer who has the name of Mike. 
        public static Customer RunProblem3(List<Customer> customers)
        {
            //code
            var listOfMike = from s in customers
                             where s.FirstName =="Mike"
                             select s;
            //return
            return (Customer)listOfMike;
        }
        #endregion
        ...
        //Then, update that customer's first name and last name to completely different names and return the newly 
        //updated customer from the method.
        public static Customer RunProblem4(List<Customer> customers)
        {
            //code 
            var id3List = from s in customers
                          where s.Id == 3
                          select s;
            //return
            return (Customer)id3List;
        }
        #endregion
